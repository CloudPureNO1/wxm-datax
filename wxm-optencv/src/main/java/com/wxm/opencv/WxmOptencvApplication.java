...
import com.wxm.opencv.demo.Demo5;
...
public class WxmOptencvApplication {
    ...
    public static void main(String[] args) {
         ...
         */
        SpringApplicationBuilder builder = new SpringApplicationBuilder(WxmOptencvApplication.class);
        builder.headless(false).web(WebApplicationType.SERVLET).run(args);
...
//        }
//
//        SpringApplication.run(WxmOptencvApplication.class, args);
    }

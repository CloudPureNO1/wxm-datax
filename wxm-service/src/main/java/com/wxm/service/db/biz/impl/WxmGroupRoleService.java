...
import com.wxm.druid.mapper.biz.WxmGroupRoleMapper;
import com.wxm.service.db.biz.IWxmGroupRoleService;
 ...
 */
@Slf4j
@Service("wxmGroupRoleService")
public class WxmGroupRoleService extends ServiceImpl<WxmGroupRoleMapper, WxmGroupRole> implements IWxmGroupRoleService {
    private final WxmGroupRoleMapper wxmGroupRoleMapper;

    public WxmGroupRoleService(WxmGroupRoleMapper wxmGroupRoleMapper) {

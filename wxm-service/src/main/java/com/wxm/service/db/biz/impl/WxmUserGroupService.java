...
import com.wxm.druid.mapper.biz.WxmUserGroupMapper;
import com.wxm.service.db.biz.IWxmUserGroupService;
 ...
 */
@Slf4j
@Service("wxmUserGroupService")
public class WxmUserGroupService extends ServiceImpl<WxmUserGroupMapper, WxmUserGroup> implements IWxmUserGroupService {
    private final WxmUserGroupMapper wxmUserGroupMapper;

    public WxmUserGroupService(WxmUserGroupMapper wxmUserGroupMapper) {

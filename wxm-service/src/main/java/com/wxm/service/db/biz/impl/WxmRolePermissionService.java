...
import com.wxm.druid.mapper.biz.WxmRolePermissionMapper;
import com.wxm.service.db.biz.IWxmRolePermissionService;
 ...
 */
@Slf4j
@Service("wxmRolePermissionService")
public class WxmRolePermissionService extends ServiceImpl<WxmRolePermissionMapper, WxmRolePermission> implements IWxmRolePermissionService {
    private final WxmRolePermissionMapper wxmRolePermissionMapper;

    public WxmRolePermissionService(WxmRolePermissionMapper wxmRolePermissionMapper) {

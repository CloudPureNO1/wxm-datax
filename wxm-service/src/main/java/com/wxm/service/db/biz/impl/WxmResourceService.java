...
import com.wxm.druid.mapper.biz.WxmResourceMapper;
import com.wxm.service.db.biz.IWxmResourceService;
...
public class WxmResourceService extends ServiceImpl<WxmResourceMapper, WxmResource> implements IWxmResourceService {
    ...
    @Override
    public WxmResource queryById(String id) throws DbSvcException {
        try{

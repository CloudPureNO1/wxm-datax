...
import com.wxm.druid.mapper.biz.WxmPermissionMapper;
import com.wxm.service.db.biz.IWxmPermissionService;
 ...
 */
@Slf4j
@Service("wxmPermissionService")
public class WxmPermissionService extends ServiceImpl<WxmPermissionMapper, WxmPermission> implements IWxmPermissionService {
    private final WxmPermissionMapper wxmPermissionMapper;

    public WxmPermissionService(WxmPermissionMapper wxmPermissionMapper) {

...
import com.wxm.druid.mapper.biz.WxmApiMapper;
 ...
 */
@Slf4j
@Service("wxmApiService")
public class WxmApiService extends ServiceImpl<WxmApiMapper, WxmApi> implements IWxmApiService {

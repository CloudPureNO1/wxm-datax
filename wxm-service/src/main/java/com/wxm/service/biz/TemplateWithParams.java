 ...
 */
@Slf4j
public abstract class TemplateWithParams<T, E, I> {
    public abstract PageInfo<?> queryPageInfo(E e) throws DbSvcException;
    ...
    public final T service(E e, Class<?> clazzSource, Class<I> clazzTarget, String msg) throws DbSvcException, BizSvcException {
        try {
            PageInfo<?> pageInfo = this.queryPageInfo(e);
            List<?> listSource = pageInfo.getList();
            ...
            return this.initOut(list,pageInfo.getTotal());
